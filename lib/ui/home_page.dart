...
class _HomePageState extends State<HomePage> {
  ...
  Future<Map> _getGifs() async {
    ...
    if (_search == null)
      ...
      response = await http.get("https://api.giphy.com/v1/gifs/search?api_key=Tpediafryx2M9rucPo9uzLjkXJW7opAs&q=$_search&limit=25&offset=$_offset&rating=G&lang=en");
